...
public class ApplicationInitializer {
    public static void main(final String[] args) {
        // Pstgress 테스트
//        final StudentService studentService = new PostgresStudentService();
//
...
//                    " || [이름] " + student.getName() +
//                    " || [생일] " + student.getBirthday());
//        });
//        System.out.println("");
//
//        System.out.println("02. 학번이 20110101인 학생을 조회합니다.");
//        result = studentService.getStudentByNo("20110101");
//        System.out.println("[학번] " + result.getNo() +
//                " || [이름] " + result.getName() +
//                " || [생일] " + result.getBirthday());
//        System.out.println("");
//
//        System.out.println("03. 이름이 일지매인 학생을 조회합니다.");
//        result = studentService.getStudentByName("일지매");
//        System.out.println("[학번] " + result.getNo() +
//                " || [이름] " + result.getName() +
//                " || [생일] " + result.getBirthday());
//        System.out.println("");
//
//        System.out.println("04. 생일이 1990-03-01 학생을 조회합니다.");
...
//        System.out.println("");
//
//        System.out.println("07. 학번이 20110901~20111201이고, \n" +
//                "이름이 이상훈, 강동희, 김호성, 김정준 학생을 추가합니다.");
...
//        };
//        resultCount = studentService.updateStudentMulti(students);
//        System.out.println(resultCount + "명의 학생 정보가 변경되었습니다.");
//        System.out.println("");
//
...
//        };
//        resultCount = studentService.deleteStudentNoMulti(students);
//        System.out.println(resultCount + "명의 학생 정보가 삭제되었습니다.");
//        System.out.println("");
